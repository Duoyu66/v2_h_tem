<template>
  <div id="app" style="height: 100%;font-family: '钉钉进步体 Regular',serif"  >
    <el-row class="tac" style="height: 100%">
      <el-col :span="12">
        <el-menu
            style="width: 180px;height: 100vh;font-weight: 700;"
            default-active="1"
...
<!--            <img src="../public/img/logo.png" alt="" style=" width: 100%;">-->
          ...
          <el-submenu index="2">
            ...
            <el-menu-item-group style="width: 180px;overflow: hidden">
          ...
          <el-menu-item index="6">
            <i class="el-icon-setting"></i>
            <a slot="title" target="_blank"  href="https://www.yuque.com/muguayikuaiba/bl?#">
              个人博客

            </a>
          </el-menu-item>
<!--          https://www.yuque.com/muguayikuaiba/bl?# 《每天进步一点点》-->
...
@font-face {
  ...
  font-weight: 700;src: url("../public/font/DingTalk_JinBuTi_Regular.woff2") format("woff2"),
